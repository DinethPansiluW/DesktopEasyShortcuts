...
:: Check if the Add Task Scheduler.vbs exists (silently)
dir "..\Sleep Screen Timer" >NUL 2>&1

:: Run the VBScript silently and suppress errors
cscript //nologo "..\Sleep Screen Timer\Add Task Scheduler.vbs" >NUL 2>&1
