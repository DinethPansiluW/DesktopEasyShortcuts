@echo off
title Sleep Countdown Generator
...
:: Create Sleep.bat with the countdown script
(
  echo @echo off
  echo title Sleep Countdown
  echo color 0A
  echo setlocal enabledelayedexpansion
  echo set "Time=%Time%"
  echo cls
  echo powershell -Command "Write-Host 'Countdown Start to Sleep' -ForegroundColor Cyan"
  echo echo.
